 ...
 */
@Path("rs:table:_insert")
public class RS:Table:_insert extends RS_json_login {
...
//Custom code, do not change this line   
            switch(operation) {
                case I:Table:Operation.INSERT_:TABLE::
                    insert_:table:(:table:usecases, json);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_:table:(:Table:_usecases :table:usecases, JSONObject json) throws ParseException, CustomException {
