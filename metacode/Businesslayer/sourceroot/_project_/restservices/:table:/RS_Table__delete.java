 ...
 */
@Path("rs:table:_delete")
public class RS:Table:_delete extends RS_json_login {
...
//Custom code, do not change this line   
            switch(operation) {
                case I:Table:Operation.DELETE_:TABLE::
                    delete_:table:(:table:usecases, json);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_:table:(:Table:_usecases :table:usecases, JSONObject json) throws ParseException, CustomException {
