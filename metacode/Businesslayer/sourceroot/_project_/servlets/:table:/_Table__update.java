 ...
 */
@WebServlet(name=":Table:_update", urlPatterns={"/:project:.:Table:_update"})
public class :Table:_update extends SecurityDataServlet {
...
//Custom code, do not change this line   
    ...
    private void update_:table:(:Table:_usecases :table:usecases) throws CustomException {
