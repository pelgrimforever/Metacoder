...
public class :Table:handler_base extends AbstractData {
    ...
    public final static String servletINSERT = ":project:.:Table:_insert";
    public final static String servletUPDATE = ":project:.:Table:_update";
    public final static String servletDELETE = ":project:.:Table:_delete";
    ...
    public static :Table:data bean(I:Table: :table:) {
    ...
    public static I:Table: load:Table:(I:Table:PK :table:pk) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletSELECT, I:Table:Operation.SELECT_:TABLE:);
    ...
    public static ArrayList search(I:Table:search search) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletSELECT, I:Table:Operation.SELECT_SEARCH);
    ...
    public static void insert:Table:(I:Table: :table:) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletINSERT, I:Table:Operation.INSERT_:TABLE:);
    ...
    public static void update:Table:(I:Table: :table:) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletUPDATE, I:Table:Operation.UPDATE_:TABLE:);
        handler.addjavaobject(":table:", :table:);
        //send request
        handler.post();
    }
    ...
    public static void delete:Table:(I:Table: :table:) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletDELETE, I:Table:Operation.DELETE_:TABLE:);
        handler.addjavaobject(":table:", :table:);
        //send request
        handler.post();
    }
...
:repeatforeignkeys:
    public static ArrayList load:Table:s4:uniquename:(I:Pktable:PK :pktable:PK) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletSELECT, I:Table:Operation.SELECT_:Uniquename:);
    ...
    public static ArrayList delete:Table:s4:uniquename:(I:Pktable:PK :pktable:PK) throws DatahandlerException, CustomException {
        Servlethandler handler = new Servlethandler(WEBSERVICE + servletSELECT, I:Table:Operation.DELETE_:Uniquename:);
        handler.addjavaobject(":pktable:pk", :pktable:PK);
        //send request
        return (ArrayList)handler.post();
    }
